...
# Script to list the first 150 Pokémons using the public PokéAPI
# API: https://pokeapi.co/api/v2/pokemon

API_URL="https://pokeapi.co/api/v2/pokemon?limit=150"

echo "Buscando os primeiros 150 Pokémons na PokéAPI..."
echo "================================================"
...
echo "================================================"
echo "Total: $(echo "$RESPONSE" | jq '.results | length') Pokémons listados."
